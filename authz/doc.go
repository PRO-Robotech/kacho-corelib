...
//
// Подсистема: KAC-108 (sub-эпик E3 эпика KAC-104).
// Acceptance: docs/specs/sub-phase-2.0-iam-E3-openfga-rebac-acceptance.md.
//
// # Архитектура
//
//	┌──────────────┐     unary/stream     ┌──────────────────────────┐
...
//
//   - Cache TTL = 5s positive-only (negative not cached — see D-9).
...
//	}
//
// Реализация (gRPC client к InternalIAMService.Check) живёт в кliente-side
