...
// NewCache создаёт кеш с указанным TTL. ttl ≤ 0 → defaults to 5*time.Second.
// (Использовать 5s — see D-9 / acceptance §4.3.)
...
//
// Set negative — не делается (D-9); если allowed=false, вызывающий не должен
// звать SetAllowed.
