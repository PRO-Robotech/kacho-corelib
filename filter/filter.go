// Package filter — простой парсер filter-выражений в стиле YC API.
//
// Текущая поддержка (Phase 2.2):
//
//	<field> = "<value>"
//
...
//
// Сообщения ошибок воспроизводят YC verbatim:
//
...
//
// Поддержка AND/OR/STARTS_WITH/IN — отложена; задокументировано в FILTER-EXPR-IGNORED.md.
package filter
...
// ParseError — ошибка парсинга с YC verbatim message.
