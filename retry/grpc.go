// Package retry — конвенциональные обёртки для повторов gRPC-вызовов с
// экспоненциальным backoff. Поверх `github.com/H-BF/corlib/pkg/backoff`.
//
...
//   - OnAborted — при codes.Aborted (OCC retry per spec §14)
