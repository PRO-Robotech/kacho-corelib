...
// Shared fixtures for drainer integration tests (W1.1 RED phase, KAC-137).
//
...
//
// NOTE: this method signature INTENTIONALLY mirrors the contract from
// acceptance §4.1 `Applier[T] = func(ctx, eventType, payload) error`.
// The exact signature mapping to the implemented drainer.Applier type
// happens in the test wiring below (currently fails to compile — RED phase).
