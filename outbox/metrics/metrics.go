// Package metrics exposes the outbox-delivery observability surface
// (sub-phase 1.4 D-7): backlog depth, oldest-pending age and poison count per
// outbox table/channel. It makes a stuck/lost owner-tuple delivery observable
// (alertable) instead of a silent Warn-log.
//
...
// them separate and never conflates poison/backlog, acceptance N5 / 1.4-41):
//
