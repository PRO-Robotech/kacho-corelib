...
// Unit + integration tests for the outbox metrics package (sub-phase 1.4, D-7).
//
// RED-phase (test-first, ban #12): `metrics.*` does not yet exist, so this file
// fails to compile. Acceptance: 1.4-23 — backlog_depth / oldest_pending_age /
// poisoned_total exposed per outbox table.
//
...
// Test_1_4_23_CollectorScan_BacklogAndOldest — acceptance 1.4-23.
//
