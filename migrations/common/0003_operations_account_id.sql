...
-- Sub-phase 1.2 (IAM operations visibility), D-5/D-8: добавить additive,
-- nullable account_id-денормализацию в общую operations-таблицу, чтобы
-- account-scoped IAM operation-listing фильтровался по ней на DB-уровне
-- (partial cursor-индекс, не software-агрегация).
--
...
-- ORDER BY created_at, id) и НЕ индексирует NULL-строки (не растёт от
-- не-IAM операций).
