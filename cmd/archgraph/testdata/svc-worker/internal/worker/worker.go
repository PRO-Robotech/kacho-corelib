...
// NetworkOutboxWorker drains the outbox table and emits events. It is
// an archgraph worker entry-point: constructed by NewNetworkOutboxWorker
// and started via Run.
...
// Run is the worker's root: the goroutine entry archgraph's call-graph
// pass walks from.
