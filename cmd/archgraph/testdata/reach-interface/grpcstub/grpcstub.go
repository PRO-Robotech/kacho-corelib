...
// protoc-gen-go-grpc stub touches. archgraph fixtures import this
// instead of the real module so they load under GOTOOLCHAIN=local with
// no network.
package grpcstub
...
// ServiceDesc is the per-service registration descriptor.
